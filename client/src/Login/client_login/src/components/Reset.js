          ...
          <div className='glass'>
            ...
            <form onSubmit={handleFormSubmit}>
              <div className="main_working_box" >
                <input {...formik.getFieldProps('password')} type="password" placeholder="Please Enter your New Password" className='textbox'/>
                <input {...formik.getFieldProps('confirm_password')} type="password" placeholder="Please Enter Again to Verify" className='textbox'/>
