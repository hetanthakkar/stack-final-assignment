        ...
        <div className="glass reg_width">
          ...
          <form className="py-1" onSubmit={formik.handleSubmit}>
            <div className="profile flex justify-center py-4">
              ...
              <input onChange={uploadFile} type="file" id="profile" name="profile" />
            </div>
            <div className="main_working_box">
              <div className="name flex w-3/4 gap-10">
                <input {...formik.getFieldProps('firstname')} type="text" placeholder="First Name" className="textbox" />
                <input {...formik.getFieldProps('lastname')} type="text" placeholder="Last Name" className="textbox" />
              </div>

              <div className="name flex w-3/4 gap-10">
                <input {...formik.getFieldProps('mobile')} type="text" placeholder="Contact Number" className="textbox" />
            ...
            <div className="text-center py-2">
              <span className="text-gray-500"><Link className="text-red-500" to="/">Log Out</Link></span>
            </div>
          </form>
        </div>
      </div>
