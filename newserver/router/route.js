...
router.route('/generateOTP').get(controller.verifyUser, OTPLocalVariables, controller.generateOTP) //generate random OTP
...
router.route('/resetPassword').put(controller.verifyUser, controller.resetPassword) //used to reset the password
